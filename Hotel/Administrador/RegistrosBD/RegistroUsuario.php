...
//Ciclo IF para revisar que esten todos los datos
				if (
					...
					isset($_POST['Codename_Usuario']) && !empty($_POST['Codename_Usuario'])&&
					isset($_POST['Password_Usuario']) && !empty($_POST['Password_Usuario'])&&
					isset($_POST['Estado_Usuario']) && !empty($_POST['Estado_Usuario'])&&
					isset($_POST['Rol_Usuario']) && !empty($_POST['Rol_Usuario']))  {

//Variables que tendran el valor que se insertara en la tabla
					
					$CodUsuario= $_POST['Nombre_Usuario'];
					$CodCodename = $_POST['Codename_Usuario'];
					$CodContra= $_POST['Password_Usuario'];
					$CodEstado = $_POST['Estado_Usuario'];
					$CodRol= $_POST['Rol_Usuario'];
...
//Variables para conectar la BD
					...
					mysqli_query($con, "INSERT INTO usuarios (Nombre_Usuario,Codename_Usuario,Password_Usuario,Estado_Usuario,Rol_Usuario) VALUES ('$CodUsuario','$CodCodename','$CodContra','$CodEstado','$CodRol')");
