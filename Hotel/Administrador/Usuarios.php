...
––>
<div id="InfoPersonal">
	<form action ="RegistrosBD/RegistroUsuario.php"  required="required" method=post name="formulario">

					<label><h2>Nombre:</h2></label><br>
					<input type="text" class="form-control-lg" id="Nombre_Usuario" name="Nombre_Usuario" /><br>


					<label><h2>Código:</h2></label><br>
					<input type="text" class="form-control-lg" id="Codename_Usuario" name="Codename_Usuario" /><br>
					
					<label><h2>Contraseña:</h2></label><br>
					<input type="text" class="form-control-lg" id="Password_Usuario" name="Password_Usuario" /><br>
					
					<label><h2>Estatus:</h2></label><br>
					<input type="text" class="form-control-lg" id="Estado_Usuario" name="Estado_Usuario" placeholder="(1 = activo , 0 = inactivo)" /><br>
					
					<label><h2>Rol:</h2></label><br>
					<input type="text" class="form-control-lg" id="Rol_Usuario" name="Rol_Usuario" placeholder="(R = Recepcionista , A = Admin )"/><br>
