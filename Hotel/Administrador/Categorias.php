...
––>
<div id="InfoPersonal">
	<form action ="RegistrosBD/RegistroCat.php"  required="required" method=post name="formulario">

					<label><h2>Nro. Categoria:</h2></label><br>
					<input type="text" class="form-control-lg" id="Cod_Categoria" name="Cod_Categoria" /><br>


					<label><h2>Nombre de Categoria:</h2></label><br>
					<input type="text" class="form-control-lg" id="Descripcion" name="Descripcion" /><br>
